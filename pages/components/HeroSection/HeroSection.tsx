...
const HeroSection = (props: HeroSection) => {
  return (
    <div className="bg-white py-7 w-full">
      ...
      <div className="flex gap-9 items-center self-start">
...
Japanese lessons</p>
                ...
                <div className="flex gap-1 items-center">
                    <p>Speaks English  <span className="bg-[#D9FAFD] text-primary text-sm">B2</span>.</p> 
                   
                    <p>Japanese  <span className="bg-green-200 text-green-400 text-sm">Native</span>.</p>
